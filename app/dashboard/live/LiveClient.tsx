                        ...
                        <div key={lead.id} className="glass p-6 rounded-[32px] border-white/5 hover:border-orange-500/30 transition-all group flex flex-col h-full bg-zinc-950/40">
                            ...
                            <div className="pt-6 border-t border-white/5 flex flex-wrap gap-2">
                                ...
                                <button 
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all group/edit"
                                    title="Edit Page"
                                >
                                    <Sliders size={16} className="text-accent-gold group-hover/edit:rotate-12 transition-transform" />
                                    <span className="text-xs font-bold uppercase tracking-wider text-white/70">Edit Page</span>
                                </button>
                            </div>
                        </div>
                    ))}
