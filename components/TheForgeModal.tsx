...
import { saveForgeCode, generateForgeCode } from '@/lib/actions';
                        ...
                        {activeTab === 'manual' ? (
                            ...
                            <div className="h-full flex flex-col items-center justify-center gap-8 bg-purple-500/[0.02] border border-dashed border-purple-500/20 rounded-[40px]">
                                ...
                                <button 
                                    ...
                                    className="px-10 py-5 bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white font-black rounded-2xl flex items-center gap-3 transition-all shadow-[0_10px_40px_rgba(168,85,247,0.3)] active:scale-95 uppercase text-xs tracking-widest"
                                >
                                    {isGenerating ? (
                                        <>
